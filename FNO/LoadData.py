...
file_list_val = 'file_list_val.txt'
dataset_dir = 'D:\NMDataset\\dataset_Wavelet'
...
class CTDoseDataset(Dataset):
    ...
    def ReadFileList(self):
        if self.is_train:
            file_list_fname = file_list_train
        else:
            file_list_fname = file_list_val
    ...
    def loadOneData(self, data_name):
        ...
        dose = torch.unsqueeze(dose,dim=3)
